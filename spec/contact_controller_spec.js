...
describe("ContactController", () => {
  ...
  describe("#addContact()", () => {
    it("should add a single contact into the book", (done) => {
      this.book.addContact("Alice", "001-101-1010", "test@example.com")
      .then((contact) => {
  ...
  describe("#getContacts()", () => {
    ...
    describe("search methods", () => {
      ...
      const snake = ["Solid Snake", "100-010-101", "snake@konami.com"];
      const magus = ["Magus Johnson", "101-101-110", "magus@squaresoft.com"];
